...
import { CheckCircle, BadgeCheck, Heart, Leaf, ArrowRight, Star, Stethoscope, FlaskRound, RefreshCw, Sparkles, Feather, Handshake, UserCog } from "lucide-react";
import AOS from "aos";
                    ...
                    <div className="flex flex-col-reverse lg:flex-row gap-10 lg:gap-14 items-center">
                        ...
                        >
                            <div className="relative w-full min-h-[280px] sm:min-h-[400px] lg:min-h-[500px] overflow-hidden rounded-md shadow-md">
                                <Image
                                    src="/assets/img/moxibustion-cones-moxa-treatment-points-top-needles.webp"
                            ...
                            <div className="flex flex-col gap-5">
                                ...
                                <div className="flex flex-col gap-[15px]">
                                    ...
                                    <div className="text-gray-500 font-ppNeueMontreal text-justify text-[15px] sm:text-[16px] md:text-[17px] leading-relaxed"
                                        ...
                                        data-aos-delay="150"
                                    >
                                        Acupuncture journeys often require a combination of medical, emotional, and holistic care. This treatment is designed to work alongside your medical fertility plan by strengthening your body’s natural functions while reducing the impact of stress and hormonal fluctuations.
                                    </div>
                                </div>
