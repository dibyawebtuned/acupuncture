...
const contactCards = [
    {
        ...
        title: 'Contact Info',
        content: (
            <span className='text-gray-700 font-testsignifier'>
    ...
    },
    {
        ...
        title: 'Address',
        content: (
            <Link href="" className='font-testsignifier text-gray-700 no-underline hover:no-underline'>
                Perth 123, Australia
            </Link>
        )
    },
        ...
        <div className='pt-[130px] bg-[#EAF0EA]'>
            <div className='container mx-auto py-15'>
                ...
                <div className='flex flex-col gap-2.5 text-center md:text-left'>
                    <div className='text-[#6D6A5F] font-testsignifier uppercase text-sm tracking-widest'>Location</div>
                    <div className='font-ppNeueMontreal text-[28px] md:text-[36px] text-[#2B2B2B]'>Contact us</div>
                </div>
                ...
                <div className='mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10'>
                    {contactCards.map((card, index) => (
                        <div
                            key={index}
                            className='flex flex-col items-start gap-[15px] sm:gap-[20px] px-5 py-[30px] bg-white shadow-md hover:shadow-lg transition-shadow duration-300'
                        >
                            <span>{card.icon}</span>
                            <div className='flex flex-col gap-2'>
                                <div className='font-ppNeueMontreal font-medium text-[20px] sm:text-[22px] md:text-[20px] text-[#2B2B2B]'>{card.title}</div>
                                <div className='ttext-gray-700 font-testsignifier text-[14px] md:text-[15px]'>{card.content}</div>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className='mt-16 flex flex-col md:flex-row gap-10'>
                    ...
                    {/* Map */}
                    <div className='md:w-1/2 h-[280px] sm:h-[350px] md:h-[420px] overflow-hidden shadow-lg'>
                        <iframe
                    ...
                    {/* Image */}
                    <div className='md:w-1/2 h-[280px] sm:h-[350px] md:h-[420px] relative overflow-hidden shadow-lg !rounded-none'>
                        <Image
                ...
                <div className='mt-16 flex flex-col md:flex-row gap-10'>
                    ...
                    <div className='md:w-1/2 flex flex-col gap-6'>
                        <div className='text-gray-700 font-testsignifier uppercase text-sm tracking-widest'>Get in touch</div>
                        <div className='font-ppNeueMontreal text-[28px] md:text-[36px] text-gray-800'>Send us a message</div>
                        ...
                        <p className='text-gray-700 font-testsignifier text-[14px] md:text-[15px]'>Here’s how we can assist you:</p>

                        <ul className='flex flex-col gap-3 text-gray-700 text-[14px] md:text-[15px]'>
                            <li className='flex items-center gap-2'><Leaf className='w-5 h-5 text-[#0B3D91]' /> Provide detailed information about our treatments</li>
                            <li className='flex items-center gap-2'><Droplet className='w-5 h-5 text-[#0B3D91]' /> Help you schedule or modify appointments</li>
                            <li className='flex items-center gap-2'><Flower2 className='w-5 h-5 text-[#0B3D91]' /> Address any specific requests or concerns you may have</li>
                        </ul>
                    </div>

                    {/* Right Form */}
                    <div className='md:w-1/2 bg-white p-6 md:p-8 shadow-md'>
