...
import { CheckCircle, BadgeCheck, Heart, Leaf, ArrowRight, Star, Stethoscope, FlaskRound, RefreshCw, ShieldCheck, AudioLines, Smile } from "lucide-react";
import AOS from "aos";
                    ...
                    <div className="flex flex-col-reverse lg:flex-row gap-10 lg:gap-14 items-center">
                        ...
                        >
                            <div className="relative w-full min-h-[280px] sm:min-h-[400px] lg:min-h-[500px] overflow-hidden rounded-md shadow-md">
                                <Image
                                    src="/assets/img/sound_therapy_one.jpg"
                        ...
                        <div className="flex-1 w-full text-left">
                            <div>
                                ...
                                >
                                    ...
                                    <br />
                                    Sessions are tailored to individual preferences and health goals. Sound therapy
                                    is offered as part of a holistic suite of supportive wellness services.
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-5">
                                ...
                                <div className="flex flex-col gap-[15px]">
                                    ...
                                    <div>
                                        ...
                                        >
                                            <Image
                                                src="/assets/img/sound_therapy_two.jpg"
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-24">
                                <div className="text-center w-48">
                                    ...
                                    <p className="text-[16px] text-gray-500 mt-2 font-ppNeueMontreal">
                                        Evaluation of health and wellness goals
                                    </p>
                                </div>
                                ...
                                <div className="text-center w-48 relative">
                                    ...
                                    <p className="text-[16px] text-gray-500 mt-2 font-ppNeueMontreal">
                                        Scheduling of sound therapy sessions as part of treatment plan
                                    </p>
                                </div>
                                ...
                                <div className="text-center w-48 relative">
                                    ...
                                    <p className="text-[16px] text-gray-500 mt-2 font-ppNeueMontreal">
                                        Continuous assessment and adaptation based on response
                                    </p>
                                </div>
                            </div>
                        </div>
